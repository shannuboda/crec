...
<div class="container">
  ...
  <div class="dropdown">
    <div class="col-md-9 page rightcontent">
      ...
      <p>
      <ul >
        <li>To equip students with essential background in computer science, basic electronics and applied mathematics.</li>
        <li>To prepare students with fundamental knowledge in programming languages, and tools and enable them to develop applications.</li>
        <li>To encourage the research abilities and innovative project development in the field of AI, ML,DL, networking, security, web development, Data Science and also emerging technologies for the cause of social benefit.</li>
		<li>To develop professionally ethical individuals enhanced with analytical skills, communication skills and organizing ability to meet industry requirements.</li>
	  </ul>
      <br>
      </p>
    </div>
...
<ul class="dept-bar">
  ...
  <li class="active"><img src="image/icons/objectives.png" class="black" /><span> <a href="dept-aiml-objectives.php">PEOs</a></span></li>
  <li class=""><img src="image/icons/outcomes.png" class="black" /> <a href="dept-aiml-outcomes.php">POs</a></li>
