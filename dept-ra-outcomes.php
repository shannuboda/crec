...
<!--
      <h1 class="page-title">PROGRAMME SPECIFIC OUTCOMES</h1>
      <ul>
        <li>To develop safe and efficient Automation and Robotic systems for the requirements and specifications.</li>
...
-->
      ...
      <ul>
        <li>To develop safe and efficient Automation and Robotic systems for the requirements and specifications. </li>
        <li>To analyse and improve the performance of Manufacturing and Production systems by implementing the latest technological advancements.</li>
        <li>To lead a professional or an entrepreneur career in industries by applying Engineering and Management principles and best practices. </li>
      </ul>
    </div>
...
<ul class="dept-bar">
  ...
  <li class="active"><img src="image/icons/outcomes.png" class="black" /> <a href="dept-ra-outcomes.php">POs</a></li>
