...
<title>Credit Course on Cyber Security by TCS | Rajalakshmi Engineering College (REC)</title>
...
<h1 class="event-title-1 text-right container" >Events</h1>
  ...
  <div class="breadcrumb"><a href="events.php">Events</a> > Credit Course on Cyber Security by TCS</div>
 <div class="rightcontent col-md-6 event-image"><img src="./image/events/CreditCourseonCyberSecuritybyTCS.jpeg" alt="Credit Course on Cyber Security by TCS" /></div>
  <div class="leftsidebar col-md-6">
  <h3>Credit Course on Cyber Security by TCS</h3><h5>23.02.2022 to 07.03.2022 | REC</h5>
  <p>Credit course on Cyber security by TCS was held from 23.02.2022 to 07.03.2022</p><br>
 <!-- <a href="" title="Credit Course on Cyber Security by TCS" rel="nofollow" target="_blank">Explore Photos</a>-->
  </div>
</div>
<!-- code page end -->
