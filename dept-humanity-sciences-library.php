    ...
    <div class="container">
        ...
        <div class="dropdown-">
            <div class="col-md-9 page rightcontent">
                <h1 class="page-title"> Department Library</h1>
                <p>
...
<ul class="dept-bar">
  ...
  <li class="active"><img src="image/icons/faculty.png" class="black" /> <a href="dept-humanity-sciences-library.php">Department Library</a></li>
