...
<div class="container">
  ...
  <a href="index.php">
  <img src="./image/logo2.png" alt="Rajalakshmi Engineering College" class="logo" title="Rajalakshmi Engineering College (REC), Chennai" />
  </a>
...
-->
   ...
   <li class="drop-top" ><a href="#" target="_blank">Admissions</a><ul class="drop-sub"><li><a href="https://www.rajalakshmi.org/2024/organic" target="_blank">UG Admissions</a></li><li><a href="https://www.rajalakshmi.org/pg-admissions-2023/" target="_blank">PG Admissions</a></li></ul></a></li>  | <li class="drop-top" ><a href="#" target="_blank">Fee Link</a><ul class="drop-sub"><li><a href="https://www.rajalakshmi.org/onlinefeepayment.php" target="_blank">College Fee</a></li><li><a href="https://eazypay.icicibank.com/eazypayLink?P1=ZNP2cDbiITjEN7JeCPQX2Q==" target="_blank">Exam Fee</a></li></ul></a></li> | <li><a href="contact-us.php">Contact Us</a></li> | <li><a href="https://www.rajalakshmi.org/downloads/TNCOGN13234-RajalakshmiEngineeringCollege-AQAR-17-18.pdf" target="_blank">AQAR</a></li></ul> </span> </div><div class="col-md-12" style="border-top:1px solid #CCCCCC;"></div>
...
background-color: #fff !important; 
  ...
  <div class="collapse navbar-collapse" id="myNavbar">
    <ul class="nav navbar-nav">
      <li class="dropdown <?php echo ($currentPage == 'profile-college.php' || $currentPage == 'profile-message.php') ? 'active' : ''; ?>"> <a class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" href="http://www.rajalakshmi.org/#">About </a>
        <ul class="dropdown-menu">
          <li><a href="profile-message.php">Correspondent's message</a></li>
          <li><a href="profile-principal.php">Principal</a></li>
          <li><a href="profile-college.php">About the college</a></li>
          <li><a href="profile-accreditations.php">Accreditations</a></li>
          <li><a href="profile-certifications.php">Certifications</a></li>
          <li><a href="profile-govrn-body.php">Governing Body</a></li>
          <li><a href="profile-acad-council.php">Academic Council</a></li>
          <li><a href="profile-mou.php">MOUs</a></li>
          <li><a href="profile-faculty.php">Eminent Faculty Members</a></li>
          <li><a href="profile-mandatory.php">Mandatory Disclosures</a></li>
<!--
...
<!--          <li><a href="http://www.rajalakshmi.org/dept-aiml-intro.php">Artificial Intelligence & Machine Learning</a></li> -->
		 ...
		 <li><a style="color: #333 !important; font-weight: lighter !important;" href="http://www.rajalakshmi.org/dept-csecs-intro.php">Computer Science &amp; Engineering (Cyber Security)</a></li>
...
-->
      ...
      <li class="dropdown "> <a href="coe.php">COE</a></li>
...
-->
      ...
      <li class="dropdown "><a class="dropdown-toggle" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" href="http://www.rajalakshmi.org/#" >Facilities</a>
        <ul class="dropdown-menu">
          <li><a href="facilities-admin.php">Administration Services</a></li>
          ...
          <li><a href="facilities-internet.php">IT Infrastructure</a></li>
          <li><a href="facilities-health.php">Health Centre</a></li>
          <li><a href="facilities-security.php">Security</a></li>
          <li><a href="facilities-lcs.php">Lecture Capturing System</a></li>
          <li><a href="facilities-greencampus.php">Green Campus</a></li>
          <li><a href="facilities-energyconservation.php">Energy Conservation</a></li>
          <li><a href="facilities-waterconservation.php">Water Conservation</a></li>
          <li><a href="facilities-infrastructure.php">Infrastructure</a></li>
          <li><a href="facilities-maintenance.php">Maintenance</a></li>
        </ul>
      </li>
      <li class="dropdown "><a class="dropdown-toggle" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" href="http://www.rajalakshmi.org/#" >Student Life</a>
        <ul class="dropdown-menu">
          ...
          <li><a href="studentlife-technical-society-activities.php">Technical Societies Activities</a></li>
      ...
      <li class="dropdown "><a class="dropdown-toggle" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" href="http://www.rajalakshmi.org/#" >Placements</a>
        <ul class="dropdown-menu">
          ...
          <li><a href="placement-skillsenhancement.php">Capacity Development and Skills Enhancement</a></li>
        </ul>
      </li>
 ...
 <li class="dropdown "> <a href="icc.php">IIC</a></li>
 <li class="dropdown "> <a href="iiic-1.php">IIIC</a></li>
...
<li class="dropdown "> <a href="nisp.php">NISP</a></li>
	
	<li class="dropdown "><a  href="international.php">IR</a>
...
-->
	...
	<li class="dropdown "><a  href="dvv_clarifications.php">NAAC</a>
    </ul>
  </div>
</nav>
</div>
