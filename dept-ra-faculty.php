...
<!--
    <tr>
      ...
      <td data-sheets-value="{'1':2,'2':'Dr. K. Ramalakshmi'}">Dr. K. Ramalakshmi</td>
      <td data-sheets-value="{'1':2,'2':'Assistant Professor'}">Professor and Head</td>
    </tr>
    <tr>
      <td data-sheets-value="{'1':3,'3':1}">2</td>
      <td data-sheets-value="{'1':2,'2':'Dr. R. Shalini'}">Dr. R. Shalini</td>
      <td data-sheets-value="{'1':2,'2':'Assistant Professor'}">Associate Professor</td>
    </tr>
		<tr>
      <td data-sheets-value="{'1':3,'3':1}">3</td>
      <td data-sheets-value="{'1':2,'2':'Dr. A. Danie Shajie'}">Dr. A. Danie Shajie</td>
      <td data-sheets-value="{'1':2,'2':'Assistant Professor'}">Associate Professor</td>
    </tr>
	<tr>
      <td data-sheets-value="{'1':3,'3':1}">4</td>
      <td data-sheets-value="{'1':2,'2':'Mr. A. Siddhu Adhiaman'}">Mr. A. Siddhu Adhiaman</td>
      <td data-sheets-value="{'1':2,'2':'Assistant Professor'}">Assistant Professor</td>
    </tr>
    <tr>
      <td data-sheets-value="{'1':3,'3':2}">5</td>
      <td data-sheets-value="{'1':2,'2':'Mrs. D. Madhushalini'}">Mrs. D. Madhushalini</td>
      <td data-sheets-value="{'1':2,'2':'Assistant Professor'}">Assistant Professor</td>
    </tr>
    <tr>
      <td data-sheets-value="{'1':3,'3':3}">6</td>
      <td data-sheets-value="{'1':2,'2':'Ms. S. Hemamalini'}">Ms. S. Hemamalini</td>
      <td data-sheets-value="{'1':2,'2':'Assistant Professor'}">Assistant Professor</td>
    </tr>
    <tr>
      <td data-sheets-value="{'1':3,'3':1}">7</td>
      <td data-sheets-value="{'1':2,'2':'Mrs. S. Sujithra'}">Mrs. S. Sujithra</td>
      <td data-sheets-value="{'1':2,'2':'Assistant Professor'}">Assistant Professor</td>
    </tr>
    <tr>
      <td data-sheets-value="{'1':3,'3':1}">8</td>
      <td data-sheets-value="{'1':2,'2':'Mr. P.N. Gururaj'}">Mr. P.N. Gururaj</td>
      <td data-sheets-value="{'1':2,'2':'Assistant Professor'}">Assistant Professor</td>
    </tr>
 -->
</table>
...
<ul class="dept-bar">
  ...
  <li class=""><img src="image/icons/info-icons.png" class="black" /> <a href="dept-ra-intro.php">Introduction</a></li>
  ...
  <li class="active"><img src="image/icons/faculty.png" class="black" /> <a href="dept-ra-faculty.php">Faculty</a></li>
