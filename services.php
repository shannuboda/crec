...
<title>International Relations | Rajalakshmi Engineering College (REC)</title>
...
<div class="profile-page">
  ...
  <div class="container">
   ...
   <h1 class="page-title">Services</h1>
	...
	<ul>
	<li>Serves as the nodal point for information and assistance to all International students.</li>
    <li>Co-ordinates with various departments and schools relating to the needs of the students.</li>
    <li>Arrange for pick of foreign interns from the airport on their arrival and departure.</li>
    <li>Arrange for Welcome and Orientation Programme for interns and foreign students.</li>
    <li>Offer support on visa extension and alien registration.</li>
    <li>Update parents/ guardians of NRI on academic performance.</li>
    <li>Organize Buddy system for Foreign Students.</li>
    <li>Offer assistance and counselling to students who have problems related to personal, professional or cultural issues.</li>
    <li>Organize special bridge course in Communicative English for students from non English speaking countries.</li>
	</ul>
	<strong>Faculty</strong>
	<ul>
	<li>Logistic arrangements</li>
    <li>Accommodation</li>
    <li>Alien Registration</li>
    <li>Co-ordinate with schools to arrange lecture schedules</li>
    </ul>
	<strong>Research</strong>
	<ul>
	<li>Identify funding opportunities</li>
    <li>Get suitable partners</li>
    <li>Assist in preparing proposals</li>
	</ul>
	<strong>Marketing</strong>
	<ul>
	<li>Visiting Partner Universities</li>
    <li>Participate in Education fairs</li>
    <li>Attend Higher Education seminars</li>
    <li>Advertise through Information pamphlets</li>
    <li>NRI students recruitment drive</li>
    </ul>
    </div>
   <div class="col-md-3 left-bar leftsidebar">
   
<ul class="dept-bar">
  <li class="left-bar-title dropbtn">International Relations</li>
  <li class=""><a href="international.php">Introduction</a></li>
  <li class="active"><a href="services.php">Services</a></li>
  <li class=""><a href="internationaladmissions.php">Admissions</a></li>
  <li class=""><a href="approval.php">Approvals, Accreditations & Honours</a></li>
   <li class=""><a href="research1.php">Research</a></li>
  
  <li class=""><a href="mous.php">MoUs</a></li>
