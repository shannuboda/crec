...
<div class="container">
  ...
  <div class="dropdown">
    <div class="col-md-9 page rightcontent">
      ...
      <ul>
        <li>An ability to apply advanced  technology for measurement and interpretation of data acquired from biological  system addressing the problems associated with the interaction between living  and non-living materials and systems </li>
        <li>An ability to use software  tools, mathematics, science and engineering for precise diagnosis and  therapeutic applications</li>
        <li>An ability to develop healthcare  information system for automation and remote access </li>
      </ul>
    </div>
...
<ul class="dept-bar">
  ...
  <li class="active"><img src="image/icons/outcomes.png" class="black" /> <a href="dept-bme-outcomes.php">POs and PSOs</a></li>
