...
<title>Artificial Intelligence & Data Science | Rajalakshmi Engineering College (REC)</title>
...
<div class="profile-page">
  ...
  <div class="container">
    <div class="breadcrumb">Department > Artificial Intelligence & Data Science</div>
    <div class="dropdown">
    
    <div class="col-md-9 page rightcontent">
    <h1 class="page-title"> Department of Artificial Intelligence & Data Science</h1>
          <strong>Programmes Offered</strong>
          <br>UG - B.Tech. Artificial Intelligence and Data Science<br><br>
<!--<div class="page-img"><img src="image/dept/Automobile-Engineering.jpg"  alt="Artificial Intelligence & Data Science" /></div>-->
   
   <p>
Artificial Intelligence and Data Science Program is introduced from the Academic Year 2022-23.
  <br><br>
<strong>       VISION:</strong>
<ul><li>To promote highly Ethical and Innovative Computer Professionals through excellence in teaching, training and research.</li></ul>
<strong>       MISSION:</strong>
<ul><li>To produce globally competent professionals, motivated to learn the emerging technologies and to be innovative in solving real world problems. </li>
...
<br />
<b>Warning</b>:  include(include/aids-menu.php): Failed to open stream: No such file or directory in <b>C:\xampp\htdocs\dept-aids-intro.php</b> on line <b>36</b><br />
<br />
<b>Warning</b>:  include(): Failed opening 'include/aids-menu.php' for inclusion (include_path='C:\xampp\php\PEAR') in <b>C:\xampp\htdocs\dept-aids-intro.php</b> on line <b>36</b><br />
