...
<p>
This course provides a comprehensive view of the world of Information Technology including Internet Applications and design, besides the traditional opportunities in computer career. Web applications require enormous knowledge of several components like Web servers, Web Protocols and to use the Web Application tools besides OOPS concept. The information technologist has greater opportunities in Software Development because of their excellent knowledge of Web Technology. In future the IT Industry will purely depend on information technologists. Besides, job opportunities in the field of IT, other options are the pursuit of higher studies in areas of Networking, Distributed Systems, Web Technologies, Information Systems, Bio Informatics and Artificial Intelligence.<br /><br />
The department of information technology was started with the aim of catering to the needs for quality IT professionals in the nations march towards digital age. The vision of the IT department is to efficiently mould the engineer's knowledge with theory and practice, using teaching skill utilizing the latest practical experiments and software to fit into areas of technology with advanced information.
</p>
<!--
      <p>
...
<ul class="dept-bar">
  ...
  <li class="active"><img src="image/icons/opport.png" class="black" /> <a href="dept-it-opportunities.php">Opportunities</a></li>
