...
<strong>Engineering Graduates will be able to,</strong>
  <li><strong>PO1</strong>: Apply the knowledge of Mathematics, Science, Engineering fundamentals, and an engineering specialization to the solution of complex engineering problems.</li>
...
<ul class="dept-bar">
  ...
  <li class=""><img src="image/icons/info-icons.png" class="black" /> <a href="dept-aiml-intro.php">Introduction</a></li>
  <li class=""><img src="image/icons/objectives.png" class="black" /><span> <a href="dept-aiml-objectives.php">PEOs</a></span></li>
  <li class="active"><img src="image/icons/outcomes.png" class="black" /> <a href="dept-aiml-outcomes.php">POs</a></li>
