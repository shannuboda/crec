...
<title>Robotics and Automation | Rajalakshmi Engineering College (REC)</title>
...
<div class="profile-page">
  ...
  <div class="container">
    <div class="breadcrumb">Department > Robotics and Automation</div>   
    <div class="col-md-9 page rightcontent">
    <h1 class="page-title">Department of Robotics and Automation</h1>
          <strong>Programmes Offered</strong>
          <br>UG - B.E. Robotics and Automation<br><br>
    <!--
	<div class="page-img"><img src="image/dept/Food-Technology.jpg" alt="Robotics and Automation" /></div>
	-->
<p>Department of Robotics and Automation is introduced from the Academic Year 2020-21. <br><br>
...
<br><br>Robot is a reprogrammable, multifunctional machine which is widely used in all fields such as Material handling, Welding, Machine Tool Tending, Palletization and De-Palletizing, Assembly, Rescuing humans and performing surgery etc. The demand for industrial robots has accelerated considerably due to the ongoing trend toward automation and continued innovative technical improvements in industrial robots. This program teaches subjects such has automated system design, robot kinematics and dynamics, motion planning, Artificial Intelligence, machine vision, Industrial Automation and Control. 
<br><br>The students will be able to improve the performance of  manufacturing and production system by implementing the latest technological advancements.
</p>

      <p>
<strong>Vision</strong><br />
To be a department of excellence in academics, research and technological advancement in Robotics and Automation with a concern for society.<br /><br />

<strong>Mission</strong><br />
To produce successful professional in Robotics and Automation by imparting high technical knowledge, strong fundamentals, practical skills and creative knowledge.<br />
To foster the students by inculcating leadership qualities to become successful Engineer.<br />
To inculcate the entrepreneurial qualities for creating, developing and managing global engineering ventures.<br />
      </p>
...
<ul class="dept-bar">
  ...
  <li class="active"><img src="image/icons/info-icons.png" class="black" /> <a href="dept-ra-intro.php">Introduction</a></li>
  <li class=""><img src="image/icons/objectives.png" class="black" /> <a href="dept-ra-objectives.php">PEOs</a></li>
  <li class=""><img src="image/icons/outcomes.png" class="black" /> <a href="dept-ra-outcomes.php">POs</a></li>
  <li class=""><img src="image/icons/opport.png" class="black" /> <a href="dept-ra-opportunities.php">Opportunities</a></li>
  <li class=""><img src="image/icons/bme-lab.png" class="black" /> <a href="dept-ra-lab.php">Lab Facility</a></li>
  <li class=""><img src="image/icons/faculty.png" class="black" /> <a href="dept-ra-faculty.php">Faculty</a></li>
  <!-- <li class=""><img src="image/icons/achieve.png" class="black" /> <a href="dept-ra-achievements.php">Achievements</a></li> -->
</ul>
