  ...
  <div class="container">
    ...
    <div class="dropdown">
      <div class="col-md-9 page rightcontent">
        ...
        <h1 class="page-title">Opportunities</h2>
          <p> Job Opportunities for an Aeronautical Engineer in India, lies with various airlines like Air India, Indian Airlines, Helicopter Corporation of India and flying clubs, private airlines and government owned air service and aircraft manufacturers like Hindustan Aeronautics Ltd. (HAL), which has its factories at Bangalore, Nashik, Koraput, Kanpur etc., Defence Research and Development Organization (DRDO), National Aerospace Laboratories (NAL), Aeronautical Development Establishment, Aeronautical Development Agency, Civil Aviation Department etc. The Defence services such as Indian Air Force (IAF), Indian Navy (IN), and Indian Space Research Organisation (ISRO) also happen to be three major employers.<br /><br />
...
<ul class="dept-bar">
  ...
  <li class=""><img src="./image/icons/outcomes.png" class="black" /> <a href="dept-aero-outcomes.php">POs</a></li>
  <li class="active"><img src="./image/icons/opport.png" class="black" /> <a href="dept-aero-opportunities.php">Opportunities</a></li>
