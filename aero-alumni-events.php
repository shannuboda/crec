...
<div class="profile-page">
  ...
  <div class="container">
    <div class="breadcrumb">Alumni > Aeronautical Engineering Alumni Events</div>
    <div class="col-md-9 page rightcontent">
    <div class="clearfix"></div>
    <h1 class="page-title">Aeronautical Engineering Alumni Events</h1>
      <p>
      <table class="table">
  <tr>
    <td>Name of the Alumni </td>
     <td><strong>Karthik S.K.</strong></td>
  </tr>
  <tr>
    <td>Batch</td>
     <td>2006-10</td>
  ...
  <tr>
    <td>Event Name</td>
     <td>Demonstration of Shock Tunnel at IISc, Bangalore</td>
  </tr>
  <tr>
    <td>Date</td>
     <td>08/07/2017</td>
  ...
  <tr>
    <td colspan="2"><img src="image/events/aero-alumni-03.jpg" alt="Aeronautical Engineering Alumni Events" class="img-responsive" /></td></tr>
</table>
<table class="table">
  <tr>
    <td>Name of the Alumni </td>
     <td><strong>Sathishkumar V.</strong></td>
  </tr>
  <tr>
    <td>Batch</td>
     <td>2012-16</td>
  ...
  <tr>
    <td>Event Name</td>
     <td>Demonstration of use of Arduino Board for automation of Traverse Mechanism</td>
  </tr>
  <tr>
    <td>Date</td>
     <td>29/06/2017</td>
  ...
  <tr>
    <td colspan="2"><img src="image/events/aero-alumni-01.jpg" alt="Aeronautical Engineering Alumni Meet" class="img-responsive" /></td></tr>
</table>
<table class="table">
  <tr>
    <td>Name of the Alumni </td>
     <td><strong>Mohankanan M</strong></td>
  </tr>
  <tr>
    <td>Batch</td>
     <td>2005-09</td>
  ...
  <tr>
    <td>Event Name</td>
     <td>Guest lecture on Design Aspects of Airbus</td>
  </tr>
  <tr>
    <td>Date</td>
     <td>25/03/2017</td>
  ...
  <tr>
    <td colspan="2"><img src="image/events/aero-alumni-02.jpg" alt="Aeronautical Engineering Alumni Meet" class="img-responsive" /></td></tr>
</table>
      </p>
    </div>
