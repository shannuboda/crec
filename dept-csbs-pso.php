...
<div class="profile-page">
  ...
  <div class="container">
    <div class="breadcrumb">Department > Computer Science and Business Systems > PSOs</div>
    <div class="dropdown-">
    
    <div class="col-md-9 page rightcontent">
    <div class="clearfix"></div>
    <h1 class="page-title">PROGRAM SPECIFIC OBJECTIVES (PSOs)</h1>
      <p>
		A graduate of the Computer Science and Business Systems program will demonstrate:
		<br>
		<ol>
		  <li>
			The students graduating will have sound knowledge in Computer Science
			with equal appreciation of humanities, management sciences and human values.
		  </li>

		  <li>
			The students will explore emerging topics such as Analytics, Machine
			Learning, Cloud Computing, and Internet of Things and apply the knowledge to
			design and develop solutions to societal needs.
		  </li>

		  <li>
			The students will be industry ready with required business skills in
			service orientation.
		  </li>
		</ol>
...
<ul class="dept-bar">
  ...
  <li class="active"><img src="image/icons/objectives.png" class="black" /> <a href="dept-csbs-pso.php">Objectives (PSOs)</a></li>
