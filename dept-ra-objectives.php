...
<div class="profile-page">
  <div class="container">
    ...
    <div class="col-md-9 page rightcontent">
      ...
      <ul>
        <li>To impart the students with strong and comprehensive knowledge in the analytical, scientific and engineering fundamentals for solving engineering problems.</li>
        <li>To impart the students with necessary design skills, product development knowledge and leadership qualities for successful industry career.</li>
<li>To instil the students with Technical expertise, Ethical practices and Team spirit and a concern towards greener society.</li>
...
<ul class="dept-bar">
  ...
  <li class="active"><img src="image/icons/objectives.png" class="black" /> <a href="dept-ra-objectives.php">PEOs</a></li>
