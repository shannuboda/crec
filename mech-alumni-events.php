...
<div class="profile-page">
  ...
  <div class="container">
    <div class="breadcrumb">Alumni > Mechanical Engineering Alumni Events</div>
    <div class="col-md-9 page rightcontent">
    <div class="clearfix"></div>
    <h1 class="page-title">Mechanical Engineering Alumni Events</h1>
      <p>
        <table class="table">
        <tr>
    <td>Name of the Alumni</td>
     <td><strong>Mr. J. Karthik</strong>
</td>
  </tr>
  <tr><td>Event Name</td>
  <td>Guest Lecture on "Recent Trends in Engineering"</td></tr>
  ...
  <tr>
    <td colspan="2"><img src="image/events/mech-alumni-01.jpg" alt="Mechanical Engineering Alumni Events" class="img-responsive" /><br />
