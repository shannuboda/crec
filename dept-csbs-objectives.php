...
<div class="profile-page">
  ...
  <div class="container">
    ...
    <h1 class="page-title">PROGRAMME  EDUCATIONAL OBJECTIVES</h1>
      <p>
		<ul>
			<li>To equip students with state of the art contemporary technology in computer science and basic engineering science.</li>
			<li>To expose students to the business principles aligned with their domain.</li>
			<li>To educate on the service orientation principles for various business disciplines.</li>
			<li>To encourage innovative research through creative thinking and critical analytical ability.</li>
			<li>To inculcate ethical and moral values in the individuals benefitting the society.</li>
		</ul> 
      </p>
    </div>
...
<ul class="dept-bar">
  ...
  <li class="active"><img src="image/icons/objectives.png" class="black" /> <a href="dept-csbs-objectives.php">Objectives (PEOs)</a></li> 
