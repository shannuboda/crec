...
<div class="profile-page">
  <div class="container">
    <div class="breadcrumb">Alumni > EEE Alumni Events</div>
    <div class="col-md-9 page rightcontent">
      <div class="clearfix"></div>
      <h1 class="page-title">Electrical and Electronics Engineering Alumni Events</h1>
      <p>
      <table class="table">
        <tr>
          <td>Name of the Alumni</td>
          <td><strong>Aparna Abhishek Iyer</strong>, Manager, Ashok Leyland Private Limited</td>
        </tr>
        <tr>
          <td>Batch</td>
          <td>2007-2011 </td>
        ...
        <tr>
          <td>Event</td>
          <td>Role of new product Development Automotive Sectors, Target Audience. Third EEE</td>
        </tr>
        <tr>
          <td>Date</td>
          <td>11/08/17</td>
        ...
        <tr>
          <td colspan="2"><img src="image/events/eee-alumni-01.jpg" alt="EEE Alumni Event" class="img-responsive" /><br /></td>
        </tr>
      </table>
      <table class="table">
        <tr>
          <td>Name of the Alumni</td>
          <td><strong>Bharath Adinarayanan</strong>, Scientist, R&D HV Division , ABB  Private Limited, Chennai </td>
        </tr>
        <tr>
          <td>Batch</td>
          <td>2005-2009</td>
        ...
        <tr>
          <td>Event</td>
          <td>Role of HV-Grid Integration- Power Target Audience - Final EEE
</td>
        </tr>
        <tr>
          <td>Date</td>
        ...
        <tr>
          <td colspan="2"><img src="image/events/eee-alumni-02.jpg" alt="EEE Alumni Event" class="img-responsive" /><br /></td>
        </tr>
      </table>
      </p>
    </div>
